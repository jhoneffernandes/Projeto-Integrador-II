...
<v-card height="100%" class="elevation-12">
    <v-toolbar
              ...
              <v-btn icon large to="/painel/usuarios/Perfis">
...
export default {
 ...
 cel: '',
      celRules: [
        ...
        v => (v && v.length <= 11) || 'O número de celular deve ser menor que 11 caractéres',
      ],

      cpf: '',
      cpfRules: [
        v => !!v || 'O CPF é obrigatório',
        v => (v && v.length <= 11) || 'O CPF deve ser menor que 11 caractéres',
      ],
