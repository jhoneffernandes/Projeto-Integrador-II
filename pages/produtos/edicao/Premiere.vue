...
export default {
  components: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Página do curso de Adobe Premiere da Diorama Cursos online' },
        // OpenGraph data (Most widely used)
    {property: 'og:title', content: 'Curso de Adobe Premiere - Diorama Cursos'},
    {property: 'og:site_name', content: 'Diorama Cursos'},
    // The list of types is available here: http://ogp.me/#types
    {property: 'og:type', content: 'website'},
    // Should the the same as your canonical link, see below.
    {property: 'og:url', content: 'http://localhost:3000/produtos/edicao/Premiere'},
    ...
    {property: 'og:description', content: 'Página do curso de Adobe Premiere da Diorama Cursos online'},

    // Twitter card
    {name: 'twitter:card', content: 'summary'},
    {name: 'twitter:site', content: 'http://localhost:3000/produtos/edicao/Premiere'},
    {name: 'twitter:title', content: 'Curso de Adobe Premiere - Diorama Cursos'},
    {name: 'twitter:description', content: 'Página do curso de Adobe Premiere da Diorama Cursos online'},
    
    // Google / Schema.org markup:
    {itemprop: 'name', content: 'Curso de Adobe Premiere- Diorama Cursos'},
    {itemprop: 'description', content: 'Página do curso deAdobe Premiere da Diorama Cursos online'},
    ...
    ,         {rel: 'canonical', href: 'http://localhost:3000/produtos/edicao/Premiere'}
    ]
  },
  data() {
    return {
