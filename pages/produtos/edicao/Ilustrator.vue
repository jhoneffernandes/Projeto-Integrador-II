  ...
  <v-container pa-0 ma-0 fluid>
    ...
    <v-col lg="10" md="12" sm="12">
      <v-row class="ml-5 fdn">
        ...
        <p>
          Este curso é compatível com o Photoshop para MAC e para PC. Ministrado utilizando OSX (MAC).
          O Illustrator apresentado no curso está em inglês.
          Sugiro fazer a instalação também em inglês na versão mais recente CC 2018
        </p>
        ...
        <p>
          ...
          Ter o Illustrator CC 2018 instalado em inglês
        </p>
      </v-row>
    </v-col>
  ...
  head: {
    ...
    meta: [
      ...
      // Meta tag description da página
      {
        hid: "description",
        name: "description",
        content: "Página do curso de Adobe Illustrator da Diorama Cursos online"
      },

      // Tags para o OpenGraph
      {
        property: "og:title",
        content: "Curso de Adobe Illustrator - Diorama Cursos"
      },
      { property: "og:site_name", content: "Diorama Cursos" },
      { property: "og:type", content: "website" },
      {
        property: "og:url",
        content: "http://localhost:3000/produtos/edicao/Ilustrator"
      },
      {
        property: "og:image",
        content:
      ...
      {
        rel: "canonical",
        href: "http://localhost:3000/produtos/edicao/Ilustrator"
      }
    ]
  },
  data() {
    return {
      nomecurso: "Adobe Illustrator cs6",
