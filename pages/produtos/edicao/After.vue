...
export default {
  ...
  head: {
    ...
    {property: 'og:title', content: 'Curso de After effects - Diorama Cursos'},
    {property: 'og:site_name', content: 'Diorama Cursos'},
    // The list of types is available here: http://ogp.me/#types
    {property: 'og:type', content: 'website'},
    // Should the the same as your canonical link, see below.
    {property: 'og:url', content: 'http://localhost:3000/produtos/edicao/After'},
    ...
    {property: 'og:description', content: 'Página do curso de After effects da Diorama Cursos online'},

    // Twitter card
    {name: 'twitter:card', content: 'summary'},
    {name: 'twitter:site', content: 'http://localhost:3000/produtos/edicao/After'},
    {name: 'twitter:title', content: 'Curso de After effects - Diorama Cursos'},
    {name: 'twitter:description', content: 'Página do curso de After effects da Diorama Cursos online'},
    
    // Google / Schema.org markup:
    {itemprop: 'name', content: 'Curso de After effects - Diorama Cursos'},
    {itemprop: 'description', content: 'Página do curso de After effects da Diorama Cursos online'},
