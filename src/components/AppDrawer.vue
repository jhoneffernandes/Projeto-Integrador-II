<template>
 ...
 <v-toolbar>
   ...
   <router-link to="/painel"> <v-list-item>
         <v-list-item-title>Voltar ao painel inicial</v-list-item-title>
          </v-list-item></router-link>

          <v-divider></v-divider>

         <router-link to="/painel/perfis"> <v-list-item>
         <v-list-item-title>Usuários</v-list-item-title>
          </v-list-item></router-link>

         <router-link to="/painel/cursos"> <v-list-item>
